...
| 2d | `detect_boundary_clip_signature` | Detect soft/hard-clip pile-up exactly at contig ends via BAM (circular-seam artefact — the counterpart to 2c's depth-drop check) — validated 2026-08 on pELF1/pELF2 vs. 6 circular negative controls (>7x margin, zero overlap) |
